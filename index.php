...
<body>
    <div class="container">
        ...
        <div class="menu">
            <h2>Menu</h2>
            <ul>
                <li>Pawis ni Heiroll - PHP 10,000</li>
                <li>Luha ni Heiroll - PHP 50,000</li>
                <li>Bathwater ni Heiroll - PHP 20,000</li>
            </ul>
        </div>
        <form method="post" action="">
            <label for="item">Select Item:</label>
            <select id="item" name="item">
                <option value="10000">Pawis ni Heiroll - PHP 10,000</option>
                <option value="50000">Luha ni Heiroll - PHP 50,000</option>
                <option value="20000">Bathwater ni Heiroll - PHP 20,000</option>
            </select><br>
